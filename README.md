...
This application uses React and Bootstrap. The font used ('Montserrat') comes from Google Fonts. The React icon used in the footer is from Font Awesome. SweetAlert was used for the win and lose messages, and ReactHowler was used for the win and lose audio files.
